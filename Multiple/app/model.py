...
class Device(threading.Thread):
    def __init__(self, name, ip, port, device_id=None, type=None, location=None, status=None, data_source=None, rate=1):
...
class Accelerometer(Device):
    ...
    def __init__(self, name, ip, port, device_id=None, type=None, location=None, status=None, data_source=None, sleep_time=5):
        super().__init__(name, ip, port, device_id, type, location, status, data_source, sleep_time)
