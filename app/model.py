...
class SensorData:
    """
    Represents a snapshot of sensor readings at a particular timestamp.

    Attributes:
    ----------
    timestamp : str
        The timestamp when the readings were taken.
    values : dict[str, int]
        The sensor readings.
    """
    timestamp: str
...
from .data_gen import gen_ts_data, generate_data  # , gen_accelerometer_data


class Device(threading.Thread):
    def __init__(self, name, ip, port, device_id=None, type=None, category=None, location=None, status=None, rate=1):
    ...
    def data_source(self):
        return generate_data()  # Replace with real data source in data_gen.py
